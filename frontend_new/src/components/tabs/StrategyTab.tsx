...
export default function StrategyTab({sessionId,machineId}:P){
  return<AgentPanel agentType="strategy" sessionId={sessionId} machineId={machineId} agentName="Strategy Optimizer" fetchFn={()=>getStrategy(sessionId,machineId)} cacheKey={`strat_${sessionId}_${machineId}`}>
    {(d)=>(
