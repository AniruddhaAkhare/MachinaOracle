...
export default function FailureTab({sessionId,machineId}:P){
  return(
    <AgentPanel agentType="failure" sessionId={sessionId} machineId={machineId} agentName="Failure Prediction" fetchFn={()=>predictFailure(sessionId,machineId)} cacheKey={`fail_${sessionId}_${machineId}`}>
