...
export default function WorkforceTab({sessionId,machineId}:P){
  return<AgentPanel agentType="workforce" sessionId={sessionId} machineId={machineId} agentName="Workforce Planner" fetchFn={()=>getWorkforce(sessionId,machineId)} cacheKey={`wf_${sessionId}_${machineId}`}>
    {(d)=>(
