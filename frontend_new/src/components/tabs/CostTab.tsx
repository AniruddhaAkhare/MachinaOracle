...
export default function CostTab({sessionId,machineId}:P){
  return<AgentPanel agentType="cost" sessionId={sessionId} machineId={machineId} agentName="Cost Analysis" fetchFn={()=>getCostAnalysis(sessionId,machineId)} cacheKey={`cost_${sessionId}_${machineId}`}>
    {(d)=>(
