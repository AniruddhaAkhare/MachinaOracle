...
export default function TimelineTab({sessionId,machineId}:P){
  return<AgentPanel agentType="timeline" sessionId={sessionId} machineId={machineId} agentName="Failure Timeline" fetchFn={()=>getTimeline(sessionId,machineId)} cacheKey={`tl_${sessionId}_${machineId}`}>
    {(d)=>(
