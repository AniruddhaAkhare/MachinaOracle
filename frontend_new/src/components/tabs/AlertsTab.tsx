...
export default function AlertsTab({sessionId,machineId}:P){
  return<AgentPanel agentType="alerts" sessionId={sessionId} machineId={machineId} agentName="Smart Alert Agent" fetchFn={()=>getAlerts(sessionId,machineId)} cacheKey={`alerts_${sessionId}_${machineId}`}>
    {(d)=>(
